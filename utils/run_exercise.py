...
class ExerciseRunner:
    ...
    def create_network(self):
        ...
        #print(type(self.switch_json)) 
        #defaultSwitchClass = []
        #for switch_json in self.switch_json:
        defaultSwitchClass = configureP4Switch(
                                sw_path=self.bmv2_exe,
                                json_path=self.switch_json[0],
                                log_console=True,
        ...
        #print(type(defaultSwitchClass))
        self.net = Mininet(topo = self.topo,
                      link = TCLink,
                      host = P4Host,
                      switch = defaultSwitchClass,
                      controller = None)
#        self.net.addSwitch(self.switches["s1"],defaultSwitchClass[1])
...
def get_args():
    ...
    parser.add_argument('-j', '--switch_json', nargs='+', type=str, required=False)
    parser.add_argument('-b', '--behavioral-exe', help='Path to behavioral executable',
                                type=str, required=False, default='simple_switch')
    parser.add_argument('--cpu-port', help= 'cpu port mapping', type=str, default=235)
...
if __name__ == '__main__':
    ...
    args = get_args()
    #print(type(args.switch_json))
    #print(args.switch_json)
    #print(args.cpu_port)
